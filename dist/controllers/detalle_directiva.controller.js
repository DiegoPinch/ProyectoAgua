...
var getDetalleDirectiva = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        connection_1.default.query('SELECT * FROM DETALLE_DIRECTIVA', function (err, data) {
            if (err)
                throw err;
            resp.json(data);
        });
...
exports.getDetalleDirectiva = getDetalleDirectiva;
var deleteDetalleDirectiva = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var id;
    return __generator(this, function (_a) {
        id = req.params.id;
        connection_1.default.query('DELETE FROM DETALLE_DIRECTIVA WHERE ID_DET_DIR = ?', id, function (err, data) {
            if (err)
                throw err;
            resp.json({
...
exports.deleteDetalleDirectiva = deleteDetalleDirectiva;
