...
exports.eliminarPersona = exports.reingresoPersona = exports.putPersona = exports.postPersona = exports.deletePersona = exports.getPersona = exports.getPersonaPasiva = exports.getPersonas = void 0;
var connection_1 = __importDefault(require("../db/connection"));
var getPersonas = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        connection_1.default.query('SELECT * FROM USUARIOS WHERE ESTADO = "Activo" ORDER BY APE_USU ASC', function (err, data) {
            if (err)
                throw err;
            resp.json(data);
        });
...
var getPersonaPasiva = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        connection_1.default.query('SELECT * FROM USUARIOS WHERE ESTADO = "PASIVO" ORDER BY APE_USU ASC', function (err, data) {
            if (err)
                throw err;
            resp.json(data);
        });
...
var deletePersona = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var id;
    return __generator(this, function (_a) {
        id = req.params.id;
...
var postPersona = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var body;
    return __generator(this, function (_a) {
        body = req.body;
        // Verificar si la cédula ya existe en la base de datos
        connection_1.default.query('SELECT * FROM USUARIOS WHERE CED_USU = ?', body.CED_USU, function (selectErr, selectData) {
            if (selectErr) {
...
var putPersona = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var id, body;
    return __generator(this, function (_a) {
        id = req.params.id;
        body = req.body;
...
var reingresoPersona = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var id;
    return __generator(this, function (_a) {
        id = req.params.id;
        try {
            connection_1.default.query('UPDATE USUARIOS SET ESTADO = ? WHERE CED_USU = ?', ['ACTIVO', id], function (updateErr, updateData) { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (updateErr) {
...
exports.reingresoPersona = reingresoPersona;
var eliminarPersona = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var id;
    return __generator(this, function (_a) {
        id = req.params.id;
